...
@Component({
  selector: 'app-detail-tindakan',
  templateUrl: './detail-tindakan.component.html',
  styleUrls: ['./detail-tindakan.component.scss'],
  providers: [ConfirmationService]
})
export class DetailTindakanComponent implements OnInit {
  selectedArr: any[]
  noregistrasi: any
  isClosing: boolean
  item: any = {}
