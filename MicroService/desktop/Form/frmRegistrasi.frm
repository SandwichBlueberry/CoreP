...
End If
         ...
         strSQL = " SELECT pm.norm AS nocm,pm.namapasien,pm.tempatlahir,to_char(pd.tglregistrasi, 'DD-MM-YYYY HH:ss') AS tglregistrasi,to_char(pm.tgllahir, 'DD-MM-YYYY') AS tgllahir, " & _
                  ...
                  " pm.namasuamiistri,pm.teleponpenanggungjawab,pm.bahasa,pm.alamatdokterpengirim,pm.dokterpengirim,pm.jeniskelaminpenanggungjawab,pm.umurpenanggungjawab,ru.namaruangan,pg.namalengkap,kp.kelompokpasien,EXTRACT (YEAR FROM AGE(pd.tglregistrasi,pm.tgllahir)) || ' Tahun ' " & _
                  " || EXTRACT (MONTH FROM AGE(pd.tglregistrasi,pm.tgllahir)) || ' Bulan ' || EXTRACT (DAY FROM AGE(pd.tglregistrasi,pm.tgllahir)) || ' Hari' AS umur " & _
                  " FROM registrasipasientr AS pd " & _
    ...
    With crCetakSuratLembarIdentitasPasien
        ...
        If Not RS2.EOF Then
            ...
            .txtTglLahir.SetText IIf(IsNull(RS2("tgllahir")), "", RS2("tgllahir")) & "/" & IIf(IsNull(RS2("umur")), "", RS2("umur")) & "/" & IIf(IsNull(RS2("jeniskelamin")), "", RS2("jeniskelamin"))
            ...
            .txtAlamatPasien.SetText IIf(IsNull(RS2("alamatlengkap")), "", RS2("alamatlengkap")) & ", Kel/Desa : " & IIf(IsNull(RS2("namadesakelurahan")), "-", RS2("namadesakelurahan")) & ", Kecamatan : " & IIf(IsNull(RS2("kecamatan")), "-", RS2("kecamatan")) & ", Kota/Kab : " & IIf(IsNull(RS2("kotakabupaten")), "-", RS2("kotakabupaten")) & ", Provinsi : " & IIf(IsNull(RS2("namapropinsi")), "-", RS2("namapropinsi"))
            .txtNotelepon.SetText IIf(IsNull(RS2("notelepon")), "", RS2("notelepon"))
            .txtNamaKeluargaPasien.SetText IIf(IsNull(RS2("penanggungjawab")), "-", RS2("penanggungjawab"))
            .txtHubunganPasien.SetText IIf(IsNull(RS2("hubungankeluargapj")), "-", RS2("hubungankeluargapj"))
            .txtAlamatKeluarga.SetText IIf(IsNull(RS2("almtpenanggungjawab")), "-", RS2("almtpenanggungjawab"))
            .txtHPKeluarga.SetText IIf(IsNull(RS2("teleponpenanggungjawab")), "-", RS2("teleponpenanggungjawab"))
...
Dim dpjp As String
    ...
    With crFormulirRajal
            ...
            adoReport.CommandType = adCmdUnknown
            .database.AddADOCommand CN_String, adoReport
            .txtRs.SetText UCase$(strNamaPemerintah)
            .txtNamaRs.SetText UCase$(strNamaLengkapRs)
            .txtNamaPasien.SetText IIf(IsNull(RS("namapasien")), "", RS("namapasien"))
